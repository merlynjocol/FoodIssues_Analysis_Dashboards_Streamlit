...
if choice == 'Home':
    ...
    with col1:
        st.title("Data Rural Hub")
        st.markdown ('<p style= "font-family:Verdana; color:Black; font-size: 20px;">Datadashboards of Food Issues from farm to fork </p>', unsafe_allow_html=True)
